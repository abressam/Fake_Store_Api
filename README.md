...
`IMPORTANTE: todos os testes constam como PASS devido a falta de informações de status code e responses retornadas da API, portanto, não houve verificações desses itens e eles apenas são apresentados nos resultados obtidos. `

`IMPORTANTE: a API não admite modificações reais em qualquer emdpoint, portanto, nenhuma alteração modificará seu database.`
...
| Test Case 2: GET Cart By ID | Listar um carrinho específico pelo seu ID |  Response: [ {<br>id: 3<br>userId: ...<br>date: "..."<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>],<br>__v: 0 } | status code: 200 <br>  Response: [ {<br>id: 3<br>userId: ...<br>date: "..."<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>],<br>__v: 0 } | PASS |  Teste ocorreu como esperado |
| Test Case 3: GET Limited List Of Carts | Listar os carrinhos a partir de intervalo limite (ex: 2) |  Response: [ {<br>id: 1<br>userId: ...<br>date: "..."<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>],<br>__v: 0 }<br>...<br>[ {<br>id: 2<br>userId: ...<br>date: "..."<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>],<br>__v: 0 } | status code: 200 <br>  Response: [ {<br>id: 1<br>userId: ...<br>date: "..."<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>],<br>__v: 0 }<br>...<br>[ {<br>id: 2<br>userId: ...<br>date: "..."<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>],<br>__v: 0 } | PASS |  Teste ocorreu como esperado |
| Test Case 4: GET Carts In Descending Order | Listas todos os carrinhos em ordem decrescente |  Response: [ {<br>id: 6<br>userId: ...<br>date: "..."<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>] }<br>...<br>[ {<br>id: 1<br>userId: ...<br>date: "..."<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>] } | status code: 200 <br> Response: [ {<br>id: 6<br>userId: ...<br>date: "..."<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>] }<br>...<br>[ {<br>id: 1<br>userId: ...<br>date: "..."<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>] } | PASS |  Teste ocorreu como esperado |
| Test Case 5: GET Carts In Ascending Order | Listas todos os carrinhos em ordem crescente |  Response: [ {<br>id: 1<br>userId: ...<br>date: "..."<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>] }<br>...<br>[ {<br>id: 6<br>userId: ...<br>date: "..."<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>] } | status code: 200 <br> Response: [ {<br>id: 1<br>userId: ...<br>date: "..."<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>] }<br>...<br>[ {<br>id: 6<br>userId: ...<br>date: "..."<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>] } | PASS |  Teste ocorreu como esperado |
| Test Case 6: GET Carts In Range Date | Listas todos os carrinhos em um intervalo de data (ex: 2019-12-10 até 2020-10-10) |  Response: [ {<br>id: ...<br>userId: ...<br>date: "2019-12-10"<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>] }<br>...<br>[ {<br>id: ...<br>userId: ...<br>date: "2020-10-10"<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>] } | status code: 400 <br> Response: <br>{ status: "error", <br> message: "cart id should be provided" } | PASS |  A API apresenta um erro nesse endpoint, pois é solicitado o id's dos carrinhos, sendo que o response deveria retorná-los |
| Test Case 7: GET User Cart | Listar um carrinho a partir de um usuário específico |  Response: [ {<br>id: ...<br>userId: 2<br>date: "..."<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>],<br>__v: 0 } | status code: 200 <br>  Response: [ {<br>id: ...<br>userId: 2<br>date: "..."<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>],<br>__v: 0 } | PASS |  Teste ocorreu como esperado |
| Test Case 8: POST Add New Cart | Registrar um novo carrinho |  Response: [ {<br>id: ...<br>userId: ...<br>date: "..."<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>],<br>__v: 0 } | status code: 200 <br>  Response: [ {<br>id: 11<br>userId: 2<br>date: "..."<br>products: [<br> { productId,<br> quantity }<br>],<br>__v: 0 } | PASS |  Teste ocorreu como esperado, porém registra o id como 11, apesar do último id ser 6.Também não apresenta o ID e a quantidade dos produtos inseridos |
| Test Case 9: DELETE Remove Cart By ID | Deleta um carrinho cadastrado |  Response: [ {<br>id: 1<br>userId: ...<br>date: "..."<br>products: [ ... ] | status code: 200 <br>  Response: [ {<br>id: 1<br>userId: ...<br>date: "..."<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>],<br>__v: 0 } | PASS |  Teste ocorreu como esperado |
<br>
</div>
...
| Test Case 11: POST Add New Cart Without Date | Validar o registro de um carrinho sem data | não documentado | status code: 200 <br> Response: {<br>id: 11<br>userId: "..."<br>date: "<br>"<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>] } | PASS | A API não está preparada para esse tipo de resposta, pois deveria falhar o teste ao invés de registrar um carrinho sem data |
| Test Case 12: POST Add New Cart With Blank Spaces Date | Validar o registro de um carrinho com espaços em branco na data | não documentado | status code: 200 <br> Response: {<br>id: 11<br>userId: "..."<br>date: "<br>"<br>products: [<br> { productId: "...",<br> quantity: "..." }<br>] } | PASS | A API não está preparada para esse tipo de resposta, pois deveria falhar o teste ao invés de registrar um carrinho com espaços em branco no campo data |
| Test Case 13: POST Add New Cart With Invalid ID Product | Validar o registro de um carrinho contendo um produto com ID inválido | não documentado | status code: 200 <br> Response: {<br>id: 11<br>userId: "..."<br>date: "..."<br>products: [<br> { productId,<br> quantity }<br>] } | PASS | A API não está preparada para esse tipo de resposta, pois deveria falhar o teste ao invés de registrar um carrinho com ID do produto inválido |
| Test Case 13: POST Add New Cart With Invalid ID Product | Validar o registro de um carrinho contendo um produto com ID inválido | não documentado | status code: 200 <br> Response: {<br>id: 11<br>userId: "..."<br>date: "..."<br>products: [<br> { productId,<br> quantity }<br>] } | PASS | A API não está preparada para esse tipo de resposta, pois deveria falhar o teste ao invés de registrar um carrinho com ID do produto inválido |
| Test Case 14: POST Add New Cart Without ID Product | Validar o registro de um carrinho contendo um produto sem ID | não documentado | status code: 200 <br> Response: {<br>id: 11<br>userId: "..."<br>date: "..."<br>products: [<br> { productId,<br> quantity }<br>] } | PASS | A API não está preparada para esse tipo de resposta, pois deveria falhar o teste ao invés de registrar um carrinho com um produto sem id |
| Test Case 15: POST Add New Cart With Blank Spaces ID Product | Validar o registro de um carrinho contendo um produto com espaços em branco ID | não documentado | status code: 200 <br> Response: {<br>id: 11<br>userId: "..."<br>date: "..."<br>products: [<br> { productId,<br> quantity }<br>] } | PASS | A API não está preparada para esse tipo de resposta, pois deveria falhar o teste ao invés de registrar um carrinho com um produto que apresenta espaços em branco no campo id |
| Test Case 16: POST Add New Cart With Zero Quantity Of Product | Validar o registro de um carrinho contendo um produto com quantidade igual a 0 | não documentado | status code: 200 <br> Response: {<br>id: 11<br>userId: "..."<br>date: "..."<br>products: [<br> { productId,<br> quantity }<br>] } | PASS | A API não está preparada para esse tipo de resposta, pois deveria falhar o teste ao invés de registrar um carrinho com um produto que apresenta zero no campo quantidade |
