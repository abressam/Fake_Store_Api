...
Test Case 4: POST User With Invalid Email
    [Tags]    4
    ${new_user}        ${status_code}        POST User Static_Data        user_invalid_email 
...
Test Case 5: POST User Without Email
    [Tags]    5
    ${new_user}        ${status_code}        POST User Static_Data        user_without_email 
    Log To Console      ${new_user}        
    Log To Console      ${status_code}
...
Test Case 6: POST User Without Username
    [Tags]    6
    ${new_user}        ${status_code}        POST User Static_Data        user_without_username
    Log To Console      ${new_user}        
    Log To Console      ${status_code}
...
Test Case 7: POST User Without Password
    [Tags]    7
    ${new_user}        ${status_code}        POST User Static_Data        user_without_password
    Log To Console      ${new_user}        
    Log To Console      ${status_code}
...
Test Case 8: POST User Without First Name
    [Tags]    8
    ${new_user}        ${status_code}        POST User Static_Data        user_without_firstname 
    Log To Console      ${new_user}        
    Log To Console      ${status_code}
...
Test Case 9: POST User Without Last Name
    [Tags]    9
    ${new_user}        ${status_code}        POST User Static_Data        user_without_lastname
    Log To Console      ${new_user}        
    Log To Console      ${status_code}
...
Test Case 10: POST User Without City
    [Tags]    10
    ${new_user}        ${status_code}        POST User Static_Data        user_without_city 
    Log To Console      ${new_user}        
    Log To Console      ${status_code}
...
Test Case 11: POST User Without Street
    [Tags]    11
    ${new_user}        ${status_code}        POST User Static_Data        user_without_street
    Log To Console      ${new_user}        
    Log To Console      ${status_code}
...
Test Case 12: POST User Without Number
    [Tags]    12
    ${new_user}        ${status_code}        POST User Static_Data        user_without_number
    Log To Console      ${new_user}        
    Log To Console      ${status_code}
...
Test Case 13: POST User Without Zipcode
    [Tags]    14
    ${new_user}        ${status_code}        POST User Static_Data        user_without_zipcode
    Log To Console      ${new_user}        
    Log To Console      ${status_code}
...
Test Case 14: POST User Without Latitude
    [Tags]    14
    ${new_user}        ${status_code}        POST User Static_Data        user_without_lat
    Log To Console      ${new_user}        
    Log To Console      ${status_code}
...
Test Case 15: POST User Without Longitude
    [Tags]    15
    ${new_user}        ${status_code}        POST User Static_Data        user_without_long
    Log To Console      ${new_user}        
    Log To Console      ${status_code}
...
Test Case 16: POST User Without Phone
    [Tags]    16
    ${new_user}        ${status_code}        POST User Static_Data        user_without_phone
    Log To Console      ${new_user}        
    Log To Console      ${status_code}
...
Test Case 17: POST Empty User 
    [Tags]    17
    ${new_user}        ${status_code}        POST User Static_Data        empty_user
    Log To Console      ${new_user}        
    Log To Console      ${status_code}
